              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-slate-400 font-bold uppercase tracking-tight">
                    {u.role === UserRole.SINDICO_ADMIN ? 'SÍNDICO / ADMINISTRATIVO' : u.role} {u.condo_id ? `• ${data.condos.find(c => c.id === u.condo_id)?.name}` : '• Global'}
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleUserSubmit} className="p-8 space-y-5">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <option value={UserRole.SINDICO_ADMIN}>Síndico / Administrativo</option>
